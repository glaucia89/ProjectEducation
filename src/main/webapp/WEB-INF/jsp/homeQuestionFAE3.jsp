...
<body>
    ...
    <jsp:include page="templates/question/FAE3/list.jsp"/>
...
<script src="${pageContext.request.contextPath}.request.contextPath}/assets/js/vendor/bootstrap/bootstrap.min.js"></script>
