        ...
        <div class="col-md-2 col-sm-2" style="position:fixed">
            ...
            <div class="col-md-8 col-sm-8 main centralizado">
                ...
                <div class=" col-xs-12 row centralizado">
                    <a class="btn btn-success" href="${pageContext.request.contextPath}/question/FAE4/add" style="width: 100%">Adicionar nova questão</a>
                                ...
                                <c:if test="${!empty item}">
                                    <tr class="active">
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-danger" href="${pageContext.request.contextPath}/question/FAE4/delete${item.id}">Remover</a>
                                        </td>
                                    </tr>
                                </c:if>
                            </c:forEach>
