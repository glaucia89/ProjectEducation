...
<div class="panel-body">
    ...
    <div class="row placeholders center-block" style="margin-top: 30px" >
        <div class="col-md-4 col-md-offset-3" >
            ...
            <button type="button" class="btn btn-lg btn-block btn-info " style="width: 200px; margin-top: 10px">
                <img src="${pageContext.request.contextPath}/assets/img/menu/audio.png" style="width: 30px; height: 30px"></img>
            </button>
            <input id="ckbox1" type="checkbox" class="form-control form-horizontal" style="width: 200px;" onclick="checkbox1Validade()" />
